...
export default makeScene2D(function* (view) {
  view.add(
    <Rect size={[1000, 1414]} fill="141414"/>
  );
  view.add(
    <Rect clip fill={light} size={[200, 200]} scale={0.5} position={[400, 607]} radius={50}>
  ...
  view.add(
    <>
      <Txt {...BaseFont} y={-607} fontSize={70} fill={text}>{`Divulgação cientifica`}</Txt>
      <Txt {...BaseFont} position={[-260, -160]} fontSize={30} fill={text}>{`Charoita`}</Txt>
      <Txt {...BaseFont} position={[-400, -350]} fontSize={15} rotation={90} fill={text}>{`https://en.wikipedia.org/wiki/Charoite`}</Txt>
      <Img src={charoite} stroke="202020" fill="202020" radius={50} lineWidth={25} position={[-260, -350]}/>
      <Img src={charoite2} stroke="202020" radius={50} lineWidth={25} position={[260, 150]}/>
      <Txt {...BaseFont} textAlign="justified" position={[180, -350]} fontSize={20} fill={text}>{`
      ...
      tal aparência
      `}</Txt>
      <Txt {...BaseFont} position={[-201, -20]} fontSize={40} fill={text}>{`Propriedades Físicas`}</Txt>
      <Txt {...BaseFont} position={[260, 270]} fontSize={20} fill={text}>{`Estrutura Química`}</Txt>
      <Txt {...BaseFont} position={[260, 300]} fontSize={20} fill={text}>{`K(Ca,Na) 2Si4 O10 (OH,F) •H2O`}</Txt>
      <Rect size={[480, 260]} position={[-201, 150]} radius={20} fill="202020">
        <Txt {...BaseFont} fontSize={20} fill={text} offset={[0, 0.1]}>{`
      ...
      <Txt {...BaseFont} position={[-189, 635]} fontSize={15} fill={text}>{`
      uujuju
